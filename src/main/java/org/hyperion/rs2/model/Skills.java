...
public class Skills {
     ...
     * @return The level.
     */
    public int getLevelForExperience(final int skill) {
        final double exp = exps[skill];
        int points = 0;
        int output = 0;
    ...
    public int getCombatLevel() {
        ...
        return Math.min(combatLevel, 126);
    }
     ...
     */
    public void setSkill(final int skill, final int level, final double exp) {
        levels[skill] = level;
        exps[skill] = exp;
     ...
     * @param exp   The experience.
     */
    public void setExperience(final int skill, final double exp) {
     ...
     */
    public void incrementLevel(final int skill) {
        levels[skill]++;
        player.getActionSender().sendSkill(skill);
    }
     ...
     */
    public void decrementLevel(final int skill) {
        levels[skill]--;
        player.getActionSender().sendSkill(skill);
    }
     ...
     */
    public void detractLevel(final int skill, int amount) {
        if (levels[skill] == 0) {
            amount = 0;
        }
     ...
     */
    public void addExperience(final int skill, final double exp) {
